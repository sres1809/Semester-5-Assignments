...
prompt2 db "Enter array elements: $"
prompt3 db "Array is: $"
prompt4 db "Final sorted array after Selection Sort:$"
prompt5 db "Final sorted array after Insertion Sort:$"
prompt6 db "Steps for the sorting--$"
len db ?
nums db 10 DUP(?), "$"
dec_out db 2 DUP(?), "$"
